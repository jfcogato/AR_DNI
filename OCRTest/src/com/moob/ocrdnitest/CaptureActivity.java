...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback
{
	...
	private int ocrEngineMode = TessBaseAPI.OEM_DEFAULT;
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		if (!hasSurface && isEngineReady) {
			Log.i(TAG, "surfaceCreated(): calling initCamera()...");
			initCamera(holder);
		}
		hasSurface = true;
	}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			if (isPaused) {
				Log.i(TAG, "only resuming continuous recognition, not quitting...");
				resumeContinuousDecoding();
				return true;
			}
	...
	private File getStorageDirectory() {
		//Log.i(TAG, "getStorageDirectory(): API level is " + Integer.valueOf(android.os.Build.VERSION.SDK_INT));
	...
	private void initOcrEngine(File storageRoot, String languageCode, String languageName) {    
		...
		if (ocrEngineMode == TessBaseAPI.OEM_CUBE_ONLY || ocrEngineMode == TessBaseAPI.OEM_TESSERACT_CUBE_COMBINED) {
			Log.i(TAG, "Disabling continuous preview");
	...
	boolean handleOcrDecode(OcrResult ocrResult) {
		...
		Log.i("TEXT:", "OCR:"+String.valueOf(ocrResult.getMeanConfidence())+"-->"+ocrResult.getText());
	...
	void handleOcrContinuousDecode(OcrResult ocrResult) {
		...
		Log.i("TEXT:", "SIZE:"+ocrResult.getBitmap().getHeight()+"--"+ocrResult.getBitmap().getWidth());
		iv.setImageBitmap(ocrResult.getBitmap());
		Log.i("TEXT:", "Confianza:"+String.valueOf(meanConfidence)+"Lineas:"+String.valueOf(ocrResult.getText().split("\r\n|\r|\n").length));
		Log.i("TEXT:", "TXT"+ocrResult.getText());
