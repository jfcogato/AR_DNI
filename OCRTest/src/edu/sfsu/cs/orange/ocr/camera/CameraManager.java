...
public final class CameraManager {
  ...
  private static final int MIN_FRAME_WIDTH = 800; // originally 240
  private static final int MIN_FRAME_HEIGHT = 480; // originally 240
  private static final int MAX_FRAME_WIDTH = 1270; // originally 480
  private static final int MAX_FRAME_HEIGHT = 720; // originally 360
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      Log.d("RESOL", "R:"+String.valueOf(screenResolution.x));
      if (screenResolution.x>=1080)
      {
    	  Log.d("RESOL", "Es xhdpi");
          framingRect = new Rect(108, 414, 108+1061, 419+207);

    	  
      }else{
    	  Log.d("RESOL", "Es solo hdpi");
          framingRect = new Rect(30, 279, 30+709, 279+138);    	  
      }
